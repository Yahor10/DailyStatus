...
public class StandartEventExpandableListAdapter extends
	...
	public StandartEventExpandableListAdapter(Context context,
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		convertView.setTag(R.id.tag_standart_event, mGroups.get(groupPosition)
				.get(childPosition));
		return convertView;
	}
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_group_event_exp_list,
					null);
			convertView.setTag(holder);
		...
		holder.firstChar.setText(""
				+ mGroups.get(groupPosition).get(0).toCharArray()[0]);
