...
/**
 * Created with IntelliJ IDEA. User: ServusKevin Date: 5/4/13 Time: 12:05 PM To
...
public class TwitterActivity extends Activity {
	...
	private void initializeComponent() {
		...
		buttonUpdateStatus
				.setOnClickListener(buttonUpdateStatusOnClickListener);
		...
		public void onClick(View v) {
			...
			if (!StringUtil.isNullOrWhitespace(status)) {
				...
				Toast.makeText(getApplicationContext(),
						"Please enter a status", Toast.LENGTH_SHORT).show();
			}
